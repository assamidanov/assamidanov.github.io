...
This blog provides an insight into the performance of solar panels deployed all across Delhi, India. We processed data from 27 different solar stations. In this blog, we will go through exploratory data analysis, particularly, data structure, outlier identification, and data accuracy. We will analyze the dataset accumulated from 25th December to 28th January. Based on this analysis, a sophisticated machine learning algorithm will be trained.
